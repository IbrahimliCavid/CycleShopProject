...
{
    /// <inheritdoc />
    public partial class BestRacerChangedAndCycleEntityChanged : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BestRacers_FacebookLink_Deleted",
                table: "BestRacers",
                columns: new[] { "FacebookLink", "Deleted" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BestRacers_InstagramLink_Deleted",
                table: "BestRacers",
                columns: new[] { "InstagramLink", "Deleted" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BestRacers_LinkedinLink_Deleted",
                table: "BestRacers",
                columns: new[] { "LinkedinLink", "Deleted" },
                unique: true);
